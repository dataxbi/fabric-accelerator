...
resource keyvault 'Microsoft.KeyVault/vaults@2023-07-01' ={
  ...
  properties:{
    ...
    accessPolicies:[
      { tenantId: subscription().tenantId
        objectId: '42640ead-4e5b-4dc8-bdbd-c823c439cce4' // Replace this with your user/group ObjectID
        permissions: {secrets:['list','get','set']}
      }
      { tenantId: subscription().tenantId
        objectId: '40ca6edd-13bc-4aa9-915f-b5699626d65b' // Replace this with your user/group ObjectID
        permissions: {secrets:['list','get','set']}
      }
    ]
  }
